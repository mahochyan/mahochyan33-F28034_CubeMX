...
CG = pathlib.Path(os.environ.get("C2000_CGT_ROOT", LOCAL_ROOT / "c2000-cgt"))
CL2000 = CG / "bin" / "cl2000.exe"
NM2000 = CG / "bin" / "nm2000.exe"
TI_DEVICE_ROOT = pathlib.Path(os.environ.get(
    "TI_DEVICE_ROOT", LOCAL_ROOT / "ti-device",
))
TI_INC = TI_DEVICE_ROOT / "include"
TI_SRC = TI_DEVICE_ROOT / "source"
CCS_PROJECT_ROOT = pathlib.Path(os.environ.get(
    "CCS_PROJECT_ROOT", LOCAL_ROOT / "ccs-project",
))
...
CPUTIMERS = pathlib.Path(os.environ.get(
    "C2000_CPUTIMERS_SOURCE", TI_SRC / "DSP2803x_CpuTimers.c",
))
